...
if (Nip13Helper::getPowDifficulty($event->getId()) >= $targetDifficulty) {
    print "Event mined successfully with difficulty $targetDifficulty " . $event->getId() . "\n";
} else {
    print "Event mining failed. Difficulty: " . Nip13Helper::getPowDifficulty($event->getId()) . "\n";
}
